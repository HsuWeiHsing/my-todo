    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <form method="post" action="{{ route('update', $task) }}">
        ...
        <div class="w-full flex flex-col">
          ...
          <textarea name="content" class="w-auto py-2 boder boder-gray-300 rounded-md" id="content" cols="30" rows="5">{{ old('content', $task->content) }}</textarea>
        </div>
        ...
        <div class="mt-8">
          <div class="w-full flex flex-col">
            ...
            value="{{ old('severity_level', $task->severity_level) }}">
        ...
        <div class="mt-8">
          <div class="w-full flex flex-col">
            ...
            <select type="text" name="importance_indication" class="w-auto py-2 boder boder-gray-300 rounded-md" id="importance_indication" value="{{ old('importance_indication', $task->importance_indication) }}">
              <option value="低">低</option>
              <option value="中">中</option>
              <option value="高">高</option>
            </select>
